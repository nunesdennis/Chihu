...
protocol FavouriteCellNotificationDelegate {
...
@MainActor
struct FavouriteCellNotification: View {
    @Environment(\.colorScheme) private var colorScheme
    
    private let notification: TootNotification
    private let delegate: FavouriteCellNotificationDelegate
    
    // MARK: - Init
    init(notification: TootNotification,
         delegate: FavouriteCellNotificationDelegate) {
